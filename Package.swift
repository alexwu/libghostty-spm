...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexwu/libghostty-spm/releases/download/storage.1.0.0/GhosttyKit.xcframework.zip",
            checksum: "dafc6b6b0bea72af6a84fddb30e715a55631db0233e2254291dcdb9748fed9a3"
        ),
        .testTarget(
            name: "GhosttyKitTest",
