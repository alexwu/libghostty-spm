...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexwu/libghostty-spm/releases/download/storage.1.0.5/GhosttyKit.xcframework.zip",
            checksum: "e99981cae70f247441e18d737c0ce8956c04793b798c5c4f0e29e6533265c12a"
        ),
        .testTarget(
            name: "GhosttyKitTest",
