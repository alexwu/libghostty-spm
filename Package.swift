...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexwu/libghostty-spm/releases/download/storage.1.0.3/GhosttyKit.xcframework.zip",
            checksum: "85cc01860de05342b716927f462b2d547299fd0ce98cd3ae66df9155d6168aaf"
        ),
        .testTarget(
            name: "GhosttyKitTest",
