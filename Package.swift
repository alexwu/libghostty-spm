...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexwu/libghostty-spm/releases/download/storage.1.0.6/GhosttyKit.xcframework.zip",
            checksum: "f4a2d14c3ce6dc6af217fe413eeaa44054a99c2d293dd7625d2e7036deffc8fa"
        ),
        .testTarget(
            name: "GhosttyKitTest",
