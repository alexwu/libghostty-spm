...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexwu/libghostty-spm/releases/download/storage.1.0.4/GhosttyKit.xcframework.zip",
            checksum: "af013d7565e9c7a724c4017aa3cf7c85f3e5b403358ec599d1222ab61e60b05c"
        ),
        .testTarget(
            name: "GhosttyKitTest",
