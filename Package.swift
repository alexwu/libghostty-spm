...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexwu/libghostty-spm/releases/download/storage.1.0.7/GhosttyKit.xcframework.zip",
            checksum: "8a5ec9fbb491080533b10efd780514832eae2255e1e1ad4a396342ec03060318"
        ),
        .testTarget(
            name: "GhosttyKitTest",
