...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexwu/libghostty-spm/releases/download/storage.1.0.1/GhosttyKit.xcframework.zip",
            checksum: "bf0b1cb40164706b05596f649960c8ef3eb32af9100792cc030b041c019a2ecd"
        ),
        .testTarget(
            name: "GhosttyKitTest",
